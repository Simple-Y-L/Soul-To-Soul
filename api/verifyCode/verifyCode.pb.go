...
type GetVerifyCodeRequest struct {
	...
	Length        uint32                 `protobuf:"varint,32,opt,name=length,proto3" json:"length,omitempty"`
...
const file_api_verifyCode_verifyCode_proto_rawDesc = "" +
	...
	"\n" +
	"VerifyCode\x12Y\n" +
	"\rGetVerifyCode\x12$.api.verifyCode.GetVerifyCodeRequest\x1a\".api.verifyCode.GetVerifyCodeReplyB9\n" +
	"\x0eapi.verifyCodeP\x01Z%kratosItems/api/verifyCode;verifyCodeb\x06proto3"
